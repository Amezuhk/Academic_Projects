...
private:
	...
	*/
	int getDepthHelper(const Book &, Node*, int) const;
	...
	*/
	Node* AtoBHelper(Book*[], int min, int max);
	...
	*/
	bool retriveHelper(Node*, const Book&, Book*&) const;
