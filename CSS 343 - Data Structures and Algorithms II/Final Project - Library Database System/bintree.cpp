...
*/
bool BinTree::insertHelper(Node* current, Book* input) {
...
*/
bool BinTree::insert(Book* input) {
...
*/
bool BinTree::retrieve(const Book& input, Book*& toReturn) const {
...
*/
bool BinTree::retriveHelper(Node* current, const Book& input,
	Book*& toReturn) const {
	if (current != nullptr) {
...
*/
int BinTree::getDepth(const Book& input) const {
...
*/
int BinTree::getDepthHelper(const Book & input, Node* current,
	int depth) const {
...
*/
void BinTree::bstreeToArray(Book* output[]) {
	int i = 0;
...
*/
int BinTree::TtoAHelper(Node* current, Book* output[], int index) {
	if (current == nullptr)
		return index;
	//in-order traversal
	if (current->left != nullptr) {
...
*/
void BinTree::arrayToBSTree(Book* data[]) {
	int max = 0;
	int min = 0;
...
*/
BinTree::Node* BinTree::AtoBHelper(Book* data[], int low, int high) {
	if (low > high)
		return nullptr;
	int mid = (low + high) / 2;
